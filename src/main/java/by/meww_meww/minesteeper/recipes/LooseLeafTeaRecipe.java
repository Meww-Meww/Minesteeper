...
import by.meww_meww.minesteeper.items.ingredients.TeaBase;
import by.meww_meww.minesteeper.utils.EffectSerialization;
import by.meww_meww.minesteeper.items.ingredients.Brewable;
...
public class LooseLeafTeaRecipe extends CustomRecipe {
    ...
    public ItemStack assemble(CraftingContainer craftingContainer, RegistryAccess registryAccess) {
        ItemStack looseLeafTeaItem = new ItemStack(MinesteeperItems.LOOSE_LEAF_TEA.get());
    ...
    public ItemStack getResultItem(RegistryAccess access) {
        return new ItemStack(MinesteeperItems.LOOSE_LEAF_TEA.get());
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return MinesteeperRecipes.LOOSE_LEAF_TEA.get();
    }
