...
public class BergamotTreeFeature extends TreeFeature {
    public BergamotTreeFeature(Codec<BergamotTreeConfiguration> configuration) {
        super((Codec)configuration);
    }

    /*private boolean doPlace(WorldGenLevel world, RandomSource random, BlockPos pos, BiConsumer<BlockPos, BlockState> roots, BiConsumer<BlockPos, BlockState> logs, FoliagePlacer.FoliageSetter leaves, TreeConfiguration configBase)
    {
