...
public class TealishBlocks {
    ...
    public static final RegistryObject<Block> BERGAMOT_LEAVES = BLOCKS.register("bergamot_leaves", () -> new LeavesBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).strength(0.2F).randomTicks().sound(SoundType.GRASS).noOcclusion().isViewBlocking((BlockState blockState, BlockGetter blockGetter, BlockPos blockPos) -> false).ignitedByLava().isRedstoneConductor(TealishBlocks::notViewBlocking).lightLevel((state) -> 8)));
