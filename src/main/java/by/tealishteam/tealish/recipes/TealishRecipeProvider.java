...
public class TealishRecipeProvider extends RecipeProvider {
    public TealishRecipeProvider(PackOutput packOutput) {
        super(packOutput);
    }

    @Override
    protected void buildRecipes(RecipeOutput output) {
        output.accept(new FinishedTeapotRecipe(new ResourceLocation(MODID, "tea"), Ingredient.of(TealishItems.LOOSE_LEAF_TEA.get()), new FluidStack(Fluids.WATER, 1000), new FluidStack(Fluids.WATER, 1000)));
    }
